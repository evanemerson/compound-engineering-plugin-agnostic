...
description: Python code quality review covering language idioms, framework patterns, logging compliance, and conventions from compound-dev.local.md.
model: sonnet
---
...
1. Read `compound-dev.local.md` from the project root to understand the stack (framework, logging library, testing framework, linter).
...
Read the `logging_library` from `compound-dev.local.md`:
