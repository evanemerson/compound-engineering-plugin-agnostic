---
description: Interactive review of findings from /compound-dev:review. Present each finding for approve, skip, or customize decisions.
...
**Announce at start:** "I'm using the compound-dev:triage command to review findings interactively."
